        ...
        try {
            ...
            if (server.getPlayerManager().getPlayer(StringArgumentType.getString(context, COMMAND_PREFIX)) instanceof EntityPlayerMPFake) {
                ...
                if (OptCarpetSettings.allowTpToRealPlayer.equals("true")) {
                    server.getCommandManager().execute(server.getCommandSource(), "tell @a Teleport " + commandSourcePlayerName + " to " + StringArgumentType.getString(context, "player"));
        ...
        try {
            ...
            if (server.getPlayerManager().getPlayer(StringArgumentType.getString(context, COMMAND_PREFIX)) instanceof EntityPlayerMPFake) {
                ...
                if (OptCarpetSettings.allowTpHereRealPlayer.equals("true")) {
                    server.getCommandManager().execute(server.getCommandSource(), "tell @a Teleport " + StringArgumentType.getString(context, "player") + " to " + commandSourcePlayerName);
