...
使用[Preprocessor](https://github.com/ReplayMod/preprocessor)构建~~可供大家学习~~，目前支持`1.17.1` `1.18.2` `1.19.3` `1.20.1`四个版本，其他的大部分大版本相同小版本不通的版本修改jar包中的`fabric.mod.json`文件后也可直接安装使用
